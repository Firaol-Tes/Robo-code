...
public class OMS extends SubsystemBase
{
    ...
    private NetworkTableEntry elevatorEncoderValue = tab.add("Elevator Encoder", 0)
                                                    .getEntry();
    private NetworkTableEntry elevatorLimitHigh = tab.add("Elevator Limit High", 0)
                                                    .getEntry();
    public OMS ()
    {
        /**
        ...
        //elevatorEncoder.setReverseDirection();
    }

    public double getHLimitSwitch()
    {
        return elevator.getLimitSwitch(Constants.M2, true);
    }

    public double getLLimitSwitch()
    {
        return elevator.getLimitSwitch(Constants.M2, false);
    }
    ...
    public void periodic()
    {
        ...
        elevatorLimitHigh.setDouble(getHLimitSwitch());
